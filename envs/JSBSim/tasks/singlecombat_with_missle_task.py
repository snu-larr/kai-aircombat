...
class SingleCombatShootMissileTask(SingleCombatDodgeMissileTask):
    ...
    def normalize_action(self, env, agent_id, action):
        ...
        return super().normalize_action(env, agent_id, action[:self.stick_action_dim].astype(np.int32))
...
class HierarchicalSingleCombatShootTask(HierarchicalSingleCombatTask, SingleCombatShootMissileTask):
    ...
    def normalize_action(self, env, agent_id, action):
        ...
        """
        self._shoot_action[agent_id] = action[self.stick_action_dim]
        return HierarchicalSingleCombatTask.normalize_action(self, env, agent_id, action[:self.stick_action_dim].astype(np.int32))
