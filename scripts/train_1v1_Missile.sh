#!/bin/sh
env="SingleCombat"
scenario="1v1/ShootMissile/vsACAM"
algo="ppo"
exp="v1"
seed=1
...
CUDA_VISIBLE_DEVICES=0 python train/train_jsbsim.py \
    ...
    --seed ${seed} --n-training-threads 1 --n-rollout-threads 2 --cuda --log-interval 1 --save-interval 1 --use-prior \
    --n-rollout-threads-port "54000 54001" \
